...
public class AuthenticationPageController {
    ...
    @PostMapping("/authenticationPage")
    public String doAuthentication(@Valid @ModelAttribute("userFormForAuthentication") UserFormForAuthentication userFormForAuthentication){
